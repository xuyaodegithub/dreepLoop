<template>
    <div class="helloFirst">
        ...
        <div class=" apps">
            ...
            <div class="OperatorRight drops" v-show="false">
                <div class="newChunk">
                    <h2>通用抠图</h2>
                    <p>人像、商品、卡通、动物全部搞定</p>
                    <div class="flex a-i">
        ...
        data() {
            return {
                ...
                colorList: [
                    ...
                    '#ffffff', '#ebebeb', '#d6d6d6', '#c2c2c2', '#adadad', '#999999', '#858585', '#707070', '#5c5c5c', '#474747', 'rgba(217,217,217,1);333', '#000000',
