    ...
    <div class="helloFirst">
        ...
        <div class=" apps">
            <div class="Operator">
                ...
                <uploadBymobile @success="deepItem" ref="uploadSub" :color="3"></uploadBymobile>
            ...
            <div class="OperatorRight drops">
                <div class="newChunk">
                    <h2>头像抠图</h2>
                    <p>身份证、签证、卡通身体、变大头照，POD最爱</p>
                    <div class="flex">
                        <div class="gif"><img src="../../assets/image/headcount.gif" alt=""></div>
                        <div class="gifright">
...
<script>
    ...
    export default {
        ...
        data() {
            return {
                initimgsList: [
                    'https://deeplor.oss-cn-hangzhou.aliyuncs.com/matting2/2020/05/21/1.jpg',
                    'https://deeplor.oss-cn-hangzhou.aliyuncs.com/matting2/2020/05/21/2.jpg',
                    'https://deeplor.oss-cn-hangzhou.aliyuncs.com/matting2/2020/05/21/3.jpg',
                    'https://deeplor.oss-cn-hangzhou.aliyuncs.com/matting2/2020/05/21/4.jpg',
                ],
                rightImgList: [],
                selectImg: 0,
                multiple: false,
