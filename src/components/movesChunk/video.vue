    ...
    <div>
        <div class="relative" ref="imgs"  @mousedown.prevent="downs" @mousemove.prevent="moves">
            <div class="posi" :style="{width:ws}">
                <video :src="imgss[0]" muted ref="videoss" loop autoplay>
                    <source :src="imgss[0]" type="video/mp4">
                    <!--                            <source :src="item" type="video/ogg">-->
                    <!--                            <source :src="item" type="video/webm">-->
                    你的游览器暂不支持视频播放，换一个试试吧！
                </video>
            </div>
            <video :src="imgss[1]" muted ref="videoss" loop autoplay>
                <source :src="imgss[1]" type="video/mp4">
                <!--                            <source :src="item" type="video/ogg">-->
                <!--                            <source :src="item" type="video/webm">-->
                你的游览器暂不支持视频播放，换一个试试吧！
            </video>
