                ...
                <div>
                    ...
                    <div class="bg_img flex" v-show="showBgList">
                        <div class="title flex a-i">
                            ...
                            <el-button round icon="el-icon-upload2" style="margin-left:30px;width:120px;font-size: 12px;line-height: 28px;border-color: #e82255;padding: 0 8px;color: #e82255;" @click="upselfImg">自定义背景</el-button>
