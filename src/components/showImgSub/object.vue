                    ...
                    <div class="bg_img flex" v-show="showBgList">
                        <div class="title flex a-i">
                            ...
                            <el-button round icon="el-icon-upload2"
                                       style="margin-left:30px;width:120px;font-size: 12px;line-height: 28px;border-color: #21a9e8;padding: 0 8px;color: #21a9e8;"
                ...
                <div>
                    ...
                    <div class="flex">
                        <down-btn v-if="bgOriginal.img" :imageMsg="imageMsg" @edireThis="edireThis" @save="save"
                                  :type="2" :mattingType="2"></down-btn>
                        <down-btn v-if="bgOriginal.img" :imageMsg="imageMsg" @edireThis="edireThis" @save="save"
                                  :type="2" down :mattingType="2"></down-btn>
                    </div>
                    <loading-sub text="为了更好的高清边缘细节，我们正在努力为你处理中" v-if="showLoading" color="#21a9e8"></loading-sub>
                </div>
            </div>
        </div>
    </div>
...
<script>
    ...
    export default {
        ...
        destroyed() {
            ...
            window.URL.revokeObjectURL(this.Original);//清除临时url
        },
        mounted() {
