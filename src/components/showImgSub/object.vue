            ...
            <div class="flex imgs">
                <div>
                    ...
                    <div class="bg_img flex" v-show="showBgList">
                        <div class="title flex a-i">
                            ...
                            <el-button round icon="el-icon-upload2" style="margin-left:30px;width:120px;font-size: 12px;line-height: 28px;border-color: #21a9e8;padding: 0 8px;color: #21a9e8;" @click="upselfImg">自定义背景</el-button>
                ...
                <div>
                    ...
                    <div class="otherBtn flex a-i"  v-if="bgOriginal.img">
                        ...
                        <span class="el-icon-picture-outline cu bg_img" @click="showBgList=!showBgList" :class="{'bordershow': choseBack=='bg'}">更换背景</span>
                        <i class="el-icon-more cu" style="font-size: 28px;color: #999;position: relative;margin-left: auto;">
                            <el-checkbox v-model="offNo" style="position: absolute;top: 100%;left: -200%;" @change="setInitStatus">设置为默认背景</el-checkbox>
                        </i>
                    ...
                    <div class="downLoadBtn" v-if="bgOriginal.img">
                        <div        class="flex a-i cu itemson"
                            ...
                            <span class="el-icon-download" style="margin-right: 6px"></span>下载<i class="el-icon-caret-bottom rotates" style="margin-left: 12px;transition: .3s all;"></i>
                            <div class="sizeChose"  :class="{'lessTop' : !(imageMsg.previewWidth!==imageMsg.originalWidth || imageMsg.previewHeight!==imageMsg.originalHeight)}">
                                <div class="flex a-i">
                                    <span>尺寸</span>
                                    <span>消耗次数</span>
                                </div>
        ...
        .sizeChose {
            ...
            & > div {
                ...
                &:last-child{
                    text-align: left;
                    margin: 10px 0 0 0;
                    a{border-bottom: 1px solid #a1a0a0;margin-left: 10px; color: #a1a0a0;}
                    color: #a1a0a0;
                }
