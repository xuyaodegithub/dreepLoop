        ...
        data() {
            return {
                ...
                fList: [
                    ...
                    {label: '站酷快乐体', value: 'zkklt'},
                    {label: '站酷庆科黄油体', value: 'zkqkhyt'},
                    {label: '站酷小微LOGO体', value: 'zkxwlgt'},
                    ...
                    {label: '胡晓波男神体', value: 'hxbns'},
                    {label: '庞门正道标题体', value: 'PangMenZhengDaoBiaoTiTi-1'},
                    {label: '庞门正道轻松体', value: 'PangMenZhengDaoQingSongTi-2'},
                    {label: '江西拙楷', value: 'jxzk'},
                    {label: '濑户字体', value: 'lhzt'},
                    {label: '杨任东竹石体', value: 'yrdzst'},
                    {label: 'Muyao-Softbrush', value: 'Muyao-Softbrush'},
                    {label: 'NotoSansCJK-Black-7', value: 'NotoSansCJK-Black-7'},
                    {label: 'NotoSansCJK-Medium-5', value: 'NotoSansCJK-Medium-5'},
                    {label: 'SourceHanSerifCN-Medium-6', value: 'SourceHanSerifCN-Medium-6'},
                    {label: 'SourceHanSerifCN-Bold-2', value: 'SourceHanSerifCN-Bold-2'},
                    {label: 'ZCOOL Addict Italic 01', value: 'ZCOOL Addict Italic 01'},
                ],
                fontSize: 24,
                color: '#333333',
